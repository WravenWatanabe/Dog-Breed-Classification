...
def split(path_, categories_):
    ...
    for category in categories_:
        ...
        for img in os.listdir(path):
            ...
            print(img)
            new_array = ip.crop_image(img_array, [IMG_SIZE, IMG_SIZE])
    ...
    Y = np_utils.to_categorical(y, len(categories_)) # One Hot Encoding
    print(Y[100])
    print(Y.shape)
    print(X.shape)
